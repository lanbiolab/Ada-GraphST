...
H5AD_PATH = "/data2/liangyefeng/My_GraphST_Innovation/data/Mouse-Brain-Section-2-Sagittal-Anterior-and-Posterior/PASTE_then_GraphST_MA_MP/MA_MP_PASTE_aligned_for_GraphST.h5ad"
...
HEATMAP_PNG = os.path.join(OUT_ROOT, "Mouse_Brain_heatmap.png")
HEATMAP_PDF = os.path.join(OUT_ROOT, "Mouse_Brain_heatmap.pdf")
LINE_PNG = os.path.join(OUT_ROOT, "Mouse_Brain_lineplot.png")
LINE_PDF = os.path.join(OUT_ROOT, "Mouse_Brain_lineplot.pdf")
