...
# =========================================================
# A. 数据集配置（Mouse Breast Cancer）
# =========================================================
PROJECT_ROOT = "/data2/liangyefeng/My_GraphST_Innovation"
DATASET_NAME = "Mouse Breast Cancer"
H5AD_PATH = "/data2/liangyefeng/My_GraphST_Innovation/data/7.Mouse_Breast_Cancer_Sample_1/mouse_breast_cancer_sample1_section1&2.h5ad"
...
SUMMARY_CSV = os.path.join(OUT_ROOT, "Mouse_Breast_Cancer_parameter_sensitivity.csv")
HEATMAP_PNG = os.path.join(OUT_ROOT, "Mouse_Breast_Cancer_heatmap.png")
HEATMAP_PDF = os.path.join(OUT_ROOT, "Mouse_Breast_Cancer_heatmap.pdf")
LINE_PNG = os.path.join(OUT_ROOT, "Mouse_Breast_Cancer_lineplot.png")
LINE_PDF = os.path.join(OUT_ROOT, "Mouse_Breast_Cancer_lineplot.pdf")
