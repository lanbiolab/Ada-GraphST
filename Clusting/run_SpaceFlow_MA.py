...
RESULT_CSV = "/data2/liangyefeng/My_GraphST_Innovation/data/Mouse-Brain-Section-2-Sagittal-Anterior-and-Posterior/MA/SpaceFlow_results.csv"
EMB_DIR = "/data2/liangyefeng/My_GraphST_Innovation/results_spaceflow_MA"
SEED = 41
...
emb_path = os.path.join(EMB_DIR, "MA_embedding.tsv")
