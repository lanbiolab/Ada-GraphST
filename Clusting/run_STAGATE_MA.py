...
RESULT_CSV = "/data2/liangyefeng/My_GraphST_Innovation/data/Mouse-Brain-Section-2-Sagittal-Anterior-and-Posterior/MA/STAGATE_results.csv"
SEED = 41
...
sc.pp.log1p(adata)
sc.pp.highly_variable_genes(adata, flavor="seurat", n_top_genes=min(3000, adata.n_vars))
