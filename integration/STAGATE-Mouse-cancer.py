...
RESULT_H5AD = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_STAGATE_result.h5ad")
RESULT_CSV = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_STAGATE_iLISI_summary.csv")
UMAP_PNG = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_STAGATE_UMAP.png")
UMAP_PDF = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_STAGATE_UMAP.pdf")
