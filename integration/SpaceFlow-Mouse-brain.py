...
ALIGNED_H5AD = os.path.join(
    ...
    "MouseBrain_MA_MP_paste_aligned_input.h5ad"
)

SAVE_DIR = os.path.join(DATA_ROOT, "PASTE_then_SpaceFlow_MA_MP")
os.makedirs(SAVE_DIR, exist_ok=True)

RESULT_H5AD = os.path.join(SAVE_DIR, "MouseBrain_MA_MP_SpaceFlow_result.h5ad")
RESULT_CSV = os.path.join(SAVE_DIR, "MouseBrain_MA_MP_SpaceFlow_iLISI_summary.csv")
UMAP_PNG = os.path.join(SAVE_DIR, "MouseBrain_MA_MP_SpaceFlow_UMAP.png")
UMAP_PDF = os.path.join(SAVE_DIR, "MouseBrain_MA_MP_SpaceFlow_UMAP.pdf")
...
if __name__ == "__main__":
    ...
    emb_path = os.path.join(EMB_DIR, "MouseBrain_MA_MP_embedding.tsv")
