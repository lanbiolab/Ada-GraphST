...
RESULT_H5AD = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_SpaGCN_result.h5ad")
RESULT_CSV = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_SpaGCN_iLISI_summary.csv")
UMAP_PNG = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_SpaGCN_UMAP.png")
UMAP_PDF = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_SpaGCN_UMAP.pdf")
...
def plot_umap_batch_domain_no_legend(
    ...
    """
    绘制 batch/domain 的 UMAP 图，但不显示任何图例，也不在标题显示 iLISI。
    """
