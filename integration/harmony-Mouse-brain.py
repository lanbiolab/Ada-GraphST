...
ALIGNED_H5AD = "/data2/liangyefeng/My_GraphST_Innovation/data/Mouse-Brain-Section-2-Sagittal-Anterior-and-Posterior/PASTE_then_GraphST_MA_MP/MA_MP_PASTE_aligned_for_GraphST.h5ad"

SAVE_DIR = "/data2/liangyefeng/My_GraphST_Innovation/data/Mouse-Brain-Section-2-Sagittal-Anterior-and-Posterior/PASTE_then_Harmony_MA_MP"
os.makedirs(SAVE_DIR, exist_ok=True)

RESULT_H5AD = os.path.join(SAVE_DIR, "MA_MP_Harmony_result.h5ad")
RESULT_CSV = os.path.join(SAVE_DIR, "MA_MP_Harmony_iLISI_summary.csv")
UMAP_PNG = os.path.join(SAVE_DIR, "MA_MP_Harmony_UMAP.png")
UMAP_PDF = os.path.join(SAVE_DIR, "MA_MP_Harmony_UMAP.pdf")
