...
RESULT_H5AD = os.path.join(SAVE_DIR, "HBCA_section1_section2_SpaceFlow_result.h5ad")
RESULT_CSV = os.path.join(SAVE_DIR, "HBCA_section1_section2_SpaceFlow_iLISI_summary.csv")
UMAP_PNG = os.path.join(SAVE_DIR, "HBCA_section1_section2_SpaceFlow_UMAP.png")
UMAP_PDF = os.path.join(SAVE_DIR, "HBCA_section1_section2_SpaceFlow_UMAP.pdf")
...
if __name__ == "__main__":
    ...
    emb_path = os.path.join(EMB_DIR, "HBCA_section1_section2_embedding.tsv")
