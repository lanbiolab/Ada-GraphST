...
SAVE_DIR = os.path.join(DATA_ROOT, "PASTE_then_STAGATE_MA_MP")
os.makedirs(SAVE_DIR, exist_ok=True)

RESULT_H5AD = os.path.join(SAVE_DIR, "MouseBrain_MA_MP_STAGATE_result.h5ad")
RESULT_CSV = os.path.join(SAVE_DIR, "MouseBrain_MA_MP_STAGATE_iLISI_summary.csv")
UMAP_PNG = os.path.join(SAVE_DIR, "MouseBrain_MA_MP_STAGATE_UMAP.png")
UMAP_PDF = os.path.join(SAVE_DIR, "MouseBrain_MA_MP_STAGATE_UMAP.pdf")
