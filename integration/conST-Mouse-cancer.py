...
SAVE_DIR = os.path.join(DATA_ROOT, "PASTE_then_conST_section1_section2")
os.makedirs(SAVE_DIR, exist_ok=True)

RESULT_H5AD = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_conST_result.h5ad")
RESULT_CSV = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_conST_iLISI_summary.csv")
UMAP_PNG = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_conST_UMAP.png")
UMAP_PDF = os.path.join(SAVE_DIR, "MouseBreastCancerSample1_section1_section2_conST_UMAP.pdf")
...
if __name__ == "__main__":
    ...
    print("Dataset: MouseBreastCancerSample1_section1_section2")
