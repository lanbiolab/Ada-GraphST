...
RESULT_H5AD = os.path.join(SAVE_DIR, "HBCA_section1_section2_conST_result.h5ad")
RESULT_CSV = os.path.join(SAVE_DIR, "HBCA_section1_section2_conST_iLISI_summary.csv")
UMAP_PNG = os.path.join(SAVE_DIR, "HBCA_section1_section2_conST_UMAP.png")
UMAP_PDF = os.path.join(SAVE_DIR, "HBCA_section1_section2_conST_UMAP.pdf")
